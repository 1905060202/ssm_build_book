  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="#">更新用户</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      <div class="row placeholders">
        <div class="col-xs-6 col-sm-3 placeholder">
          <form action="${pageContext.request.contextPath}/book/real_update_user" method="post" class="form-horizontal " role="form">
            <div class="form-group">
              <label class="col-sm-4 control-label">用户id:</label>
              <div class="col-sm-8">
                <input id="reader_id" type="text" class="form-control" placeholder="用户id" name="reader_id">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="xm" type="text" class="form-control" placeholder="姓名" name="name">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="birth" type="text" class="form-control" placeholder="生日" name="birth">
              </div>
            </div>
            <div class="form-group">
