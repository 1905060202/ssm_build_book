                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="course" items="${list}">
                        <tr>
                            ...
                            <td>
                                <img src="${pageContext.request.contextPath}/book/showPic/${course.coursepic}" style="width:100px; height: 100px;"/>
                            </td>
                            <td>
                                <a href="../book/downloadPic/${course.coursepic}">下载图片</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
