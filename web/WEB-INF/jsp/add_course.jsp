    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="#" >上新课程</a></li>
                <li><a href="${pageContext.request.contextPath}/book/update_course">更新课程</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">上架课程</h1>

            <div class="row placeholders">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <form action="${pageContext.request.contextPath}/book/real_add_course" method="post" class="form-horizontal " role="form" modelAttribute="list"  enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">id:</label>
                            <div class="col-sm-8">
                                <input id="zh" type="text" class="form-control" placeholder="id" name="id">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">课程名:</label>
                            <div class="col-sm-8">
                                <input id="pwd_real" type="text" class="form-control" placeholder="课程名" name="name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">课时:</label>
                            <div class="col-sm-8">
                                <input id="pb" type="text" class="form-control" placeholder="课时" name="hours">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">所属学院:</label>
                            <div class="col-sm-8">
                                <input id="isbn" type="text" class="form-control" placeholder="所属学院" name="schools">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="nike" type="file" class="form-control-file"  name="course_pic">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-8">
                                <button id="login" type="submit" class="btn btn-success" >上新</button>
                            </div>
                        </div>
