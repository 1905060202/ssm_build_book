  ...
  <div class="site-wrapper-inner">
    ...
    <div class="cover-container">
      ...
      <div class="masthead clearfix">
        <div class="inner">
          <h3 class="masthead-brand">自由而无用</h3>
          <nav>
      ...
      <div class="inner cover">
        <h1 class="cover-heading">欲买桂花同载酒，终不似，少年游</h1>
        <p class="lead"> 谨以此页，纪念逝去的青春</p>

      </div>

      <div class="mastfoot">
        <div class="inner">
          <p>Cover template for <a href="https://getbootstrap.com/">Bootstrap</a>, by <a href="https://twitter.com/jk199767857324">@胡小宁</a>.</p>
        </div>
      </div>
